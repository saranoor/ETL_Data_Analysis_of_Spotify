# -*- coding: utf-8 -*-
"""
Created on Thu Apr  2 18:21:16 2020
...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  2 17:26:39 2020
...
query="""
SELECT A.tracks,A.a_name, A.a_popularity, A.followers 
    FROM artists_database A
    LEFT JOIN tracks_database T
    ON T.name=A.tracks
    """
All_join_tables=pd.read_sql_query(query,con=engine)



query="""
        SELECT T.artist_name, T.popularity, A.a_popularity, A.tracks
        FROM tracks_database  T
        LEFT JOIN artists_database A
        ON T.artist_name=A.a_name and T.name=A.tracks
    """
Half_join_tables=pd.read_sql_query(query,con=engine)
...
query="""
    ...
    """
difference=pd.read_sql_query(query,con=engine)
